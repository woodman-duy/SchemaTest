...
@XmlType
@XmlRootElement
public abstract class Lead extends AbstractPersistentBean {
	/**
	 * For Serialization
	 * @hidden
	 */
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("{contactDetails.lastName}", this);
		}
	...
	public void setContactDetails(ContactDetailExtension contactDetails) {
		if (this.contactDetails != contactDetails) {
