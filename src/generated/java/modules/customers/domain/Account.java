...
@XmlType
@XmlRootElement
public abstract class Account extends AbstractPersistentBean {
	/**
	 * For Serialization
	 * @hidden
	 */
	...
	public static enum RelationshipType implements Enumeration {
		...
		public static RelationshipType fromLocalisedDescription(String description) {
			RelationshipType result = null;
	...
	public String getBizKey() {
		try {
			return org.skyve.util.Binder.formatMessage("{accountName}", this);
		}
	...
	public void setPrimaryContact(ContactDetailExtension primaryContact) {
		if (this.primaryContact != primaryContact) {
