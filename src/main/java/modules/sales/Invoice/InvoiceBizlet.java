...
public class InvoiceBizlet extends Bizlet<InvoiceExtension> {
	...
	public InvoiceExtension newInstance(InvoiceExtension bean) throws Exception {
		...
		bean.setInvoiceId(CORE.getNumberGenerator().next("INV", InvoiceExtension.MODULE_NAME, InvoiceExtension.DOCUMENT_NAME,
				InvoiceExtension.invoiceIdPropertyName, 8));
